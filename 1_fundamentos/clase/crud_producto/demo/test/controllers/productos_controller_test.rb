...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { decimal: @producto.decimal, descripcion: @producto.descripcion, imagen_url: @producto.imagen_url, precio: @producto.precio, string: @producto.string, titulo: @producto.titulo }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { decimal: @producto.decimal, descripcion: @producto.descripcion, imagen_url: @producto.imagen_url, precio: @producto.precio, string: @producto.string, titulo: @producto.titulo }
    assert_redirected_to producto_path(assigns(:producto))
  end
